...
class TourController(TourView):
    ...
    def first_match(self, player_list, match_list, tournament_match, gameset_match_list):
        ...
        gameset_match_list.append(match_one_tuple)

        tournament_match.append(match_two)
        tournament_match.append(match_two_reverse)
        gameset_match_list.append(match_two_tuple)

        tournament_match.append(match_three)
        tournament_match.append(match_three_reverse)
        gameset_match_list.append(match_three_tuple)

        tournament_match.append(match_four)
        tournament_match.append(match_four_reverse)
        gameset_match_list.append(match_four_tuple)

    def tournament_match_set(self, player_list, match_list, tournament_match, gameset_match_list):
        ...
        if match_one in tournament_match:
            ...
            self.check_match(player_list, match_list, tournament_match, gameset_match_list)
    ...
    def tournament_rematch(self, player_list, match_list, tournament_match, gameset_match_list):
        ...
        if match_one in tournament_match:
            ...
            print("On refait le tirage")
            match_list.clear()
            self.recheck_match(player_list, match_list, tournament_match, gameset_match_list)
    ...
    def check_match(self, player_list, match_list, tournament_match, gameset_match_list):
        """check if a match alreday made"""
        print("Contrôle des matchs...")
        self.tournament_rematch(player_list, match_list, tournament_match, gameset_match_list)

    def recheck_match(self, player_list, match_list, tournament_match, gameset_match_list):
        """check if a match alreday made"""
        print("Contrôle des matchs...")
